...
; CHECK-LE:       ; %bb.0:
; CHECK-LE-NEXT:    ldr z0, [x0]
; CHECK-LE-NEXT:    ldr z1, [x0, #1, mul vl]
; CHECK-LE-NEXT:    ldr z2, [x0, #2, mul vl]
; CHECK-LE-NEXT:    ldr z3, [x0, #3, mul vl]
; CHECK-LE-NEXT:    ldr z4, [x0, #4, mul vl]
; CHECK-LE-NEXT:    ret
;
