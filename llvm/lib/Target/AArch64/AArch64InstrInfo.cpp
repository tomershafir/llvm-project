...
bool AArch64InstrInfo::isAsCheapAsAMove(const MachineInstr &MI) const {
  ...
  bool
  AArch64InstrInfo::shouldReMaterializeTrivialRegDef(const MachineInstr *CopyMI,
...
/// NOTE: must maintain consistency with `AArch64Subtarget::canLowerToZeroCycleRegMove` 
/// and `AArch64Subtarget::canLowerToZeroCycleRegZeroing`.
